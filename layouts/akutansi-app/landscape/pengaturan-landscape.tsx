...
interface IPengaturanLandscapeLayoutProps {
    navigation: any;
};
...
const PengaturanLandscapeLayout: FC<IPengaturanLandscapeLayoutProps> = ({navigation}) => {
...
export default PengaturanLandscapeLayout;